...
<div align="center">
  <img src="assets/code-agent-full.png" alt="Bridge Code Agent 实际对话示例" width="360">
</div>
...
| 电脑上已安装至少一个 AI CLI | `gemini`、`claude`、`codex` 之一 |
...
Webhook 地址       http://127.0.0.1:18082/webhook   ← Agent 与 Bridge 在同一台电脑时用此地址
...
4. Webhook 地址是否可达？在电脑上 `curl -X POST http://127.0.0.1:18082/webhook -d '{}'`
